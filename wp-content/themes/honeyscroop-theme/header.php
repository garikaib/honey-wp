...
<head>
    ...
    <link rel="icon" type="image/png" sizes="192x192" href="<?php echo esc_url( get_template_directory_uri() . '/favicons/favicon-192x192.png' ); ?>">
    <link rel="icon" type="image/webp" href="<?php echo esc_url( get_template_directory_uri() . '/favicons/favicon.webp' ); ?>">
