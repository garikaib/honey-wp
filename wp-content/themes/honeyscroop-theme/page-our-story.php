...
<div class="our-story-page bg-textured-paper py-20 overflow-hidden relative">
    
    <!-- Hero Section: Adventure Begins -->
    <div class="container mx-auto px-4 mb-32 relative z-10">
        <div class="text-center max-w-4xl mx-auto">
            <h1 class="font-handwritten text-6xl md:text-8xl text-honey-600 mb-6 transform -rotate-2 inline-block relative">
                The Adventure Begins
                <div class="doodle-svg absolute -top-8 -right-12 w-16 h-16 text-honey-400">
                   <!-- Sun Doodle -->
            ...
            <p class="font-note text-2xl text-gray-700 max-w-2xl mx-auto rotate-1 tracking-wide">
    ...
    <div class="container mx-auto px-4 mb-32 relative z-10">
        <div class="flex flex-col md:flex-row items-center justify-center gap-12">
            ...
            <div class="md:w-1/2 max-w-md text-center md:text-right">
                <h2 class="font-handwritten text-5xl text-gray-800 mb-6 relative inline-block">
                    Curiosity Begins
                    <span class="absolute -bottom-2 left-0 w-full h-1 bg-honey-300 rounded transform -rotate-1"></span>
                </h2>
                ...
                <p class="font-note text-2xl text-honey-600 transform -rotate-1">
            ...
            <div class="md:w-1/2 flex justify-center md:justify-start">
                <div class="polaroid-frame bg-white w-full max-w-md transform rotate-3 relative">
                    ...
                    <div class="font-handwritten text-3xl text-center text-gray-800">
                        A Pure, Sweet Taste
                    </div>
                </div>
            </div>
    ...
    <div class="container mx-auto px-4 mb-32 relative z-10">
        <div class="relative bg-white rounded-lg shadow-xl p-8 md:p-12 max-w-5xl mx-auto transform -rotate-1 border border-gray-100">
            <!-- Tape corners -->
            ...
            <div class="flex flex-col md:flex-row items-center gap-12">
                <!-- Image -->
                <div class="md:w-2/5">
                     <div class="polaroid-frame transform -rotate-3 w-full">
                         ...
                         <div class="font-handwritten text-2xl text-center">Vincent Mutimbanyoka</div>
                         <div class="font-note text-lg text-center text-gray-500">Founder & Chief Taster</div>
                     </div>
                </div>

                <!-- Content -->
                <div class="md:w-3/5">
                    <h2 class="font-handwritten text-5xl text-honey-600 mb-6">A Sweet Discovery</h2>
                    <div class="prose prose-lg text-gray-600">
                        <p class="italic mb-4 text-xl border-l-4 border-honey-300 pl-4 bg-honey-50 py-2 pr-2">
    ...
    <div class="container mx-auto px-4 mb-32">
        <h2 class="font-handwritten text-6xl text-center text-gray-800 mb-16">The Why</h2>
        
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <!-- Card 1 -->
            <div class="polaroid-frame transform rotate-2 h-auto">
                ...
                <h3 class="font-handwritten text-2xl mb-2 text-center">Zimbabwean Roots</h3>
                <p class="font-note text-lg text-center text-gray-600">Proudly local produce, harvested from our vibrant landscapes.</p>
            </div>

            <!-- Card 2 -->
            <div class="polaroid-frame transform -rotate-1 mt-12 md:mt-0">
                <div class="h-64 mb-4 overflow-hidden rounded">
                ...
                <h3 class="font-handwritten text-2xl mb-2 text-center">Empowerment</h3>
                <p class="font-note text-lg text-center text-gray-600">Uplifting rural communities and Zimbabwean exporters.</p>
            </div>

            <!-- Card 3 -->
            <div class="polaroid-frame transform rotate-3">
                ...
                <h3 class="font-handwritten text-2xl mb-2 text-center">Pure Quality</h3>
                <p class="font-note text-lg text-center text-gray-600">Testing against the highest global standards.</p>
            </div>
        </div>
    </div>
    
    <!-- Parallax / Passion Found -->
    <div class="w-full relative py-20 bg-honey-100 overflow-hidden mb-20 group">
         <!-- Abstract Bee BG -->
         ...
         <div class="container mx-auto px-4 relative z-10 text-center">
             <h2 class="font-handwritten text-6xl text-honey-800 mb-8">Passion Found</h2>
             <p class="text-xl md:text-3xl font-light text-honey-900 max-w-4xl mx-auto leading-relaxed">
    ...
    <div class="container mx-auto px-4 mb-20">
         <div class="flex flex-col-reverse md:flex-row items-center gap-12 bg-white p-8 rounded-3xl border-4 border-dashed border-honey-200">
             
             <!-- Content -->
             <div class="md:w-1/2">
                 <h2 class="font-handwritten text-5xl text-gray-800 mb-6">Sustainability</h2>
