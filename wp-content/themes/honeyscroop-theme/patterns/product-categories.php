 ...
 */
?>
<section class="pattern-section py-24">
    <div class="container container-wide">
        <h3 class="text-center text-3xl md:text-4xl font-serif font-bold text-honey-900 dark:text-honey-50 mb-16 transition-colors">Choose By Product Category</h3>
