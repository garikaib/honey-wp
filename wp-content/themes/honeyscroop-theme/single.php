...
<div class="bg-white">
    ...
    <div class="relative h-[75vh] min-h-[600px] w-full overflow-hidden">
        ...
        <div class="absolute bottom-0 left-0 w-full leading-none text-cream-50 overflow-hidden">
            <svg class="relative block w-[calc(100%+1.3px)] h-[50px] transform rotate-180" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
                <path d="M0,0V46.29c47.79,22.2,103.59,32.17,158,28,70.36-5.37,136.33-33.31,206.8-37.5C438.64,32.43,512.34,53.67,583,72.05c69.27,18,138.3,24.88,209.4,13.08,36.15-6,69.85-17.84,104.45-29.34C989.49,25,1113-14.29,1200,52.47V0Z" opacity=".25" fill="#FFFBEB"></path>
                <path d="M0,0V15.81C13,36.92,27.64,56.86,47.69,72.05,99.41,111.27,165,111,224.58,91.58c31.15-10.15,60.09-26.07,89.67-39.8,40.92-19,84.73-46,130.83-49.67,36.26-2.85,70.9,9.42,98.6,31.56,31.77,25.39,62.32,62,103.63,73,40.44,10.79,81.35-6.69,119.13-24.28s75.16-39,116.92-43.05c59.73-5.85,113.28,22.88,168.9,38.84,30.2,8.66,59,6.17,87.09-7.5,22.43-10.89,48-26.93,60.65-49.24V0Z" opacity=".5" fill="#FFFBEB"></path>
    ...
    <!-- Content -->
    <div class="bg-cream-50 pb-20">
        <div class="container mx-auto px-4">
            <div class="max-w-3xl mx-auto -mt-20 relative z-10 bg-white p-8 md:p-16 rounded-t-3xl shadow-xl">
                <!-- Drop Cap & Prose -->
                <div class="prose prose-lg md:prose-xl prose-stone prose-headings:font-serif prose-headings:text-secondary-900 prose-p:font-light prose-p:leading-relaxed prose-a:text-amber-600 prose-a:no-underline hover:prose-a:underline prose-blockquote:border-l-4 prose-blockquote:border-amber-400 prose-blockquote:bg-amber-50/50 prose-blockquote:py-4 prose-blockquote:px-8 prose-blockquote:rounded-r-lg prose-blockquote:not-italic prose-blockquote:font-serif prose-img:rounded-2xl prose-img:shadow-lg first-letter:float-left first-letter:text-7xl first-letter:pr-4 first-letter:font-serif first-letter:text-amber-600 font-serif-content">
                    <?php the_content(); ?>
                </div>
            ...
            <div class="max-w-6xl mx-auto mt-20">
                <div class="flex items-center justify-between mb-10">
                    <h3 class="text-3xl font-serif text-secondary-900">You Might Also Like</h3>
                    <a href="<?php echo esc_url(get_permalink(get_option('page_for_posts'))); ?>" class="text-sm font-bold tracking-widest text-amber-600 uppercase hover:text-amber-700 transition-colors">View All Stories</a>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <article class="group bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300">
                        ...
                        <div class="p-6">
                            <div class="text-xs font-bold text-amber-600 uppercase tracking-wider mb-2">
                                <?php $cats = get_the_category(); if($cats) echo esc_html($cats[0]->name); ?>
                            </div>
                            <h4 class="text-xl font-serif text-secondary-900 mb-2 leading-tight group-hover:text-amber-600 transition-colors">
