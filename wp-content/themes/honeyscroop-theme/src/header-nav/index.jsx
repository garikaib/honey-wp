...
const NavItem = ({ item }) => {
    ...
    const [activeCategory, setActiveCategory] = useState(item.children ? item.children[0].category : null);
    ...
    return (
        ...
        >
            ...
            {hasChildren && (
                ...
                >
                    {isMega ? (
                        <div className="bg-white shadow-xl rounded-sm flex min-w-[400px]">
                            {/* Left Column: Categories */}
                            <div className="w-48 py-4 border-r border-gray-100 bg-white">
                                <ul>
                                        ...
                                        <li key={idx}>
                                            <div
                                                ...
                                                className={`flex items-center justify-between px-6 py-2.5 text-[13px] font-medium cursor-pointer transition-colors
                                                    ${activeCategory === child.category ? 'text-amber-600 bg-amber-50/20' : 'text-gray-600 hover:text-amber-600'}
                                                `}
                                            >
                            ...
                            <div className="w-56 py-6 px-6 bg-white">
                        ...
                        /* Standard Dropdown */
                        <ul className="bg-white shadow-xl rounded-sm min-w-[200px] py-4">
                            {item.children.map((child, idx) => (
                                <li key={idx}>
                                    <a
                                        href={child.href}
...
const HeaderNav = () => {
    ...
    return (
        <>
            ...
            {/* Mobile Menu Button - This just triggers, full mobile nav can be added later */}
        </>
    );
};
